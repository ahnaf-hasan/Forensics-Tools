...
## 🚨 কেন Digital Forensics দরকার?

🦠 Cyber attack বা malware incident বিশ্লেষণ করতে |

🔓 Hacker কীভাবে সিস্টেমে ঢুকেছে তা জানতে |

📂 কোন data চুরি বা পরিবর্তন হয়েছে কিনা বুঝতে |

⚖️ Legal evidence হিসেবে ব্যবহার করতে |



## 🛠️ Digital Forensics এর ধাপসমূহ

🔎 Identification
কোন ডিভাইস বা ডেটা থেকে evidence পাওয়া যাবে তা চিহ্নিত করা |

🧊 Preservation
Evidence যেন পরিবর্তন না হয়, সে জন্য নিরাপদে সংরক্ষণ করা |

📊 Analysis
Log files, deleted files, malware behavior বিশ্লেষণ করা |

📝 Reporting
পুরো ঘটনার পরিষ্কার রিপোর্ট তৈরি করা |


## 💡 Digital Forensics এর ধরন
...
ভবিষ্যতের attack প্রতিরোধ করতে সাহায্য করে |
